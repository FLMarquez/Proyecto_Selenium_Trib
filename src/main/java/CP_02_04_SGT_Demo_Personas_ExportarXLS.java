...
public class CP_02_04_SGT_Demo_Personas_ExportarXLS {
    ...
    public void Loguin() throws InterruptedException {
        ...
        // Verificar la descarga de archivos Excel
        ...
        assertTrue(excelDownloaded, "No se descargó el archivo Excel correctamente");
